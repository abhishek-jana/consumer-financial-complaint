...
class FrequencyEncoder(Estimator, HasInputCols, HasOutputCols,
    ...
    """
    DefaultParamsReadable, DefaultParamsWritable : Make object serialize and deserialize
    Estimator : Provide fit function that we have to overwrite
    HasInputCols, HasOutputCols : get input and output function
    """
    frequencyInfo = Param(Params._dummy(), "getfrequencyInfo", "getfrequencyInfo",
                        typeConverter=TypeConverters.toList)

    @keyword_only # save input argument in _input_kwargs variable
    ...
    def _fit(self, dataframe: DataFrame):
        ...
        replace_info = []
        # dataframe is immutable in pyspark
