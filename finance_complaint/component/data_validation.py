...
class DataValidation():
    ...
    def get_unwanted_and_high_missing_value_columns(self, dataframe: DataFrame, threshold: float = 0.3) -> List[str]: # keep 0.2 deployment
        try:
    ...
    def drop_unwanted_columns(self, dataframe: DataFrame) -> DataFrame:
        """
        Save unwanted cols to rejected dir
        """
        try:
